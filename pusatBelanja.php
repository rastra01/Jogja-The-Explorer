...
<?php
$result = mysqli_query($conn, "SELECT * FROM pusatbelanja");
?>
    ...
    <div class="gallery-container">
        ...
        <div class="image-grid">
            ...
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                $gambar = $row['gambarBelanja'];
                $judul = $row['judulBelanja'];
            ?>
                <div class="image-item">
                    <a href="detail_belanja.php?judul=<?php echo urlencode($judul); ?>">
                        <img src="<?php echo $gambar; ?>" alt="<?php echo $judul; ?>">
                    </a>
                    <div class="image-description">
                        <a href="detail_belanja.php?judul=<?php echo urlencode($judul); ?>"><?php echo $judul; ?></a>
                </div>
           </div>
            <?php
            }
