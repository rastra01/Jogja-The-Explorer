...
<?php
$result = mysqli_query($conn, "SELECT * FROM wisataalam");
?>
        ...
        <div class="image-grid">
            ...
            ?>
                <div class="image-item">
                    <a href="detail_wisata.php?judul=<?php echo urlencode($judul); ?>">
                        <img src="<?php echo $gambar; ?>" alt="<?php echo $judul; ?>">
                    </a>
                    <div class="image-description">
                        <a href="detail_wisata.php?judul=<?php echo urlencode($judul); ?>"><?php echo $judul; ?></a>
                </div>
           </div>
            <?php
            }
