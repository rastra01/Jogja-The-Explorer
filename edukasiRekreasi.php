...
<?php
$result = mysqli_query($conn, "SELECT * FROM edukasirekreasi");
?>

<br><br>
    <div class="gallery-container">
        <h2>Edukasi dan Rekreasi</h2>
        <div class="image-grid">
            <?php
            while ($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
                $gambar = $row['gambarEdukasi'];
                $judul = $row['judulEdukasi'];
            ?>
                <div class="image-item">
                    <a href="detail_rekreasi.php?judul=<?php echo urlencode($judul); ?>">
                        <img src="<?php echo $gambar; ?>" alt="<?php echo $judul; ?>">
                    </a>
                    <div class="image-description">
                        <a href="detail_rekreasi.php?judul=<?php echo urlencode($judul); ?>"><?php echo $judul; ?></a>
                </div>
           </div>
            <?php
            }
